export const TellerAbi = [
  ...
  { inputs: [], name: "LayerZeroTeller__ZeroMessageGasLimit", type: "error" },
  { inputs: [], name: "LzTokenUnavailable", type: "error" },
  { inputs: [], name: "MessageLib__ShareAmountOverflow", type: "error" },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint128", name: "messageGasLimit", type: "uint128" },
    ],
    name: "addChain",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint16", name: "sharePremium", type: "uint16" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "sharesBridged", type: "uint256" },
    ],
    stateMutability: "payable",
    type: "function",
  },
